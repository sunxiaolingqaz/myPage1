...
function(e, t) {
    ...
    function o(t) {
        ...
        if (o.innerHTML = b(t.title).split("\n").join("<br>"), r.innerHTML = b(t.text || "").split("\n").join("<br>"), t.text && w(r), x(n.querySelectorAll(".icon")), t.type) {
            for (var l = !1,
            s = 0; s < f.length; s++) if (t.type === f[s]) {
                l = !0;
                break
            }
            if (!l) return e.console.error("Unknown alert type: " + t.type),
            !1;
            var u = n.querySelector(".icon." + t.type);
            switch (w(u), t.type) {
            case "success":
                g(u, "animate"),
                g(u.querySelector(".tip"), "animateSuccessTip"),
                g(u.querySelector(".long"), "animateSuccessLong");
                break;
            case "error":
                g(u, "animateErrorIcon"),
                g(u.querySelector(".x-mark"), "animateXMark");
                break;
            case "warning":
                g(u, "pulseWarning"),
                g(u.querySelector(".body"), "pulseWarningIns"),
                g(u.querySelector(".dot"), "pulseWarningIns")
            }
        }
        if (t.imageUrl) {
    ...
    function r(e, t) {
        ...
        var n = "#",
        o, r;
        for (r = 0; 3 > r; r++) o = parseInt(e.substr(2 * r, 2), 16),
    ...
    function l() {
        ...
        v(r, "animateErrorIcon"),
        v(r.querySelector(".x-mark"), "animateXMark");
    ...
    e.sweetAlert = e.swal = function() {
        function n(e) {
            ...
            if ( - 1 !== [9, 13, 32, 27].indexOf(t)) {
                for (var n = e.target || e.srcElement,
                o = -1,
                r = 0; r < h.length; r++) if (n === h[r]) {
                    o = r;
                    break
                }
        ...
        if (void 0 === arguments[0]) return e.console.error("sweetAlert expects at least 1 attribute!"),
        !1;
        ...
        case "string":
            ...
            break;
        case "object":
            if (void 0 === arguments[0].title) return e.console.error('Missing "title" argument!'),
            !1;
            ...
            u.showCancelButton = arguments[0].showCancelButton || u.showCancelButton,
        ...
        for (var d = y(), f = function(e) {
            ...
            case "focus":
                ...
                break;
            case "click":
                n && a && o && u.doneFunction(),
                l()
            }
        },
        p = d.querySelectorAll("button"), g = 0; g < p.length; g++) p[g].onclick = f,
        p[g].onmouseover = f,
        p[g].onmouseout = f,
        p[g].onmousedown = f,
        p[g].onfocus = f;
        ...
        t.onclick = function(e) {
            ...
            o = k(d, e.target),
            r = m(d, "visible"),
            a = "true" === d.getAttribute("data-allow-ouside-click"); ! n && !o && r && a && l()
        };
        var v = d.querySelector("button.confirm"),
        b = d.querySelector("button.cancel"),
    ...
    function() {
        "complete" === t.readyState || "interactive" === t.readyState ? n() : t.addEventListener ? t.addEventListener("DOMContentLoaded",
        function e() {
            t.removeEventListener("DOMContentLoaded", arguments.callee, !1),
            n()
        },
        !1) : t.attachEvent && t.attachEvent("onreadystatechange",
        function() {
